                ...
                {canEdit && (
                    <div>
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            ...
                            >
                                <span className="material-symbols-outlined text-[24px] mb-1 align-middle inline-block">calendar_today</span>
                            ...
                            >
                                <span className="material-symbols-outlined text-[24px] mb-1 align-middle inline-block">flag</span>
                    ...
                    <div className="bg-brand-mint/10 dark:bg-black/20 p-6 rounded-3xl border border-brand-mint/20 text-center">
                        <div className="flex items-center justify-center gap-6 mb-6">
                                ...
                                {canEdit ? (
                                    <div className="relative group">
                                         ...
                                         <div className="absolute top-0 right-0 opacity-0 transition-opacity pointer-events-none">
                                            <svg className="text-gray-400" width="14" height="14" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM21.41 6.34a1.25 1.25 0 0 0 0-1.77l-2.98-2.98a1.25 1.25 0 0 0-1.77 0l-1.83 1.83 3.75 3.75 1.83-1.83z"/></svg>
                                         </div>
                                    </div>
                                ) : (
                            ...
                            {canEdit && (
                                ...
                                >
                                    <svg width="32" height="32" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M19 13H13v6h-2v-6H5v-2h6V5h2v6h6v2z"/></svg>
                                </button>
                            )}
                        </div>
            ...
            <div className="space-y-4">
                <div className="p-4 bg-brand-purple/5 dark:bg-brand-purple/10 rounded-2xl border border-brand-purple/10 dark:border-brand-purple/20">
                    <div className="flex justify-between items-center mb-2">
                        <h3 className="text-sm font-bold text-brand-purple dark:text-purple-200 flex items-center gap-1"><svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M12 3l2.25 4.5L19 9l-4.5 2.25L12 16l-2.25-4.5L5 9l4.75-1.5L12 3z"/></svg> AI 教練</h3>
                        <button 
                            onClick={fetchAdvice} 
                            disabled={loadingAi}
