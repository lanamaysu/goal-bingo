...
export const PageLoading: React.FC<{ title?: string; subtitle?: string }> = ({
  ...
  <div
    className="min-h-screen flex flex-col items-center justify-center bg-brand-mint/30 dark:bg-[rgb(var(--brand-dark))] animate-fade-in transition-colors duration-300"
