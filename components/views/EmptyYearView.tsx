    ...
    >
      <div className="max-w-md w-full bg-white dark:bg-[rgb(var(--brand-surface))] rounded-3xl shadow-xl p-8 text-center space-y-6 border border-white/20 dark:border-brand-teal/20">
        <div className="space-y-2">
          <h2 className="text-4xl font-black text-brand-mint dark:text-brand-mint/10 opacity-50 dark:opacity-100">
            {year}
          </h2>
          <h1 className="text-xl font-bold text-brand-petrol dark:text-brand-mint">
            尚未建立遊戲資料
          </h1>
        ...
        <div className="relative">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-2 bg-white dark:bg-[rgb(var(--brand-surface))] text-brand-teal/60 font-bold">
              OR
            </span>
          </div>
        </div>
