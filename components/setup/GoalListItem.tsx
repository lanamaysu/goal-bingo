  ...
  return (
    ...
    >
      <div className="flex justify-between items-start mb-1">
        <div
          className={`text-xs ${isEmpty ? 'text-gray-400 dark:text-gray-500' : 'text-gray-400 dark:text-brand-mint/60'}`}
        >
          目標 {index + 1}
        </div>
      ...
      <div
        className={`font-bold text-lg ${isEmpty ? 'text-gray-400 dark:text-gray-600' : 'text-gray-800 dark:text-brand-mint'}`}
      >
